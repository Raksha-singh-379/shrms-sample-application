...
import { EntityArrayResponseType, ProjectsService } from '../service/projects.service';
...
export class ProjectsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProjects): number => this.projectsService.getProjectsIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IProjects[] | null): IProjects[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.projectsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
