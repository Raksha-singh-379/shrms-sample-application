...
type RestOf<T extends ICompany | NewCompany> = Omit<T, 'createdOn' | 'lastModified'> & {
...
export class CompanyService {
  ...
  protected convertDateFromClient<T extends ICompany | NewCompany | PartialUpdateCompany>(company: T): RestOf<T> {
    return {
      ...company,
      createdOn: company.createdOn?.toJSON() ?? null,
  ...
  protected convertDateFromServer(restCompany: RestCompany): ICompany {
    return {
      ...restCompany,
      createdOn: restCompany.createdOn ? dayjs(restCompany.createdOn) : undefined,
