...
type RestOf<T extends IDistrict | NewDistrict> = Omit<T, 'createdOn' | 'lastModified'> & {
...
export class DistrictService {
  ...
  protected convertDateFromClient<T extends IDistrict | NewDistrict | PartialUpdateDistrict>(district: T): RestOf<T> {
    return {
      ...district,
      createdOn: district.createdOn?.toJSON() ?? null,
  ...
  protected convertDateFromServer(restDistrict: RestDistrict): IDistrict {
    return {
      ...restDistrict,
      createdOn: restDistrict.createdOn ? dayjs(restDistrict.createdOn) : undefined,
