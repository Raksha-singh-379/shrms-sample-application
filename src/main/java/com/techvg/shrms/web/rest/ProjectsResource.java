...
import com.techvg.shrms.service.ProjectsQueryService;
import com.techvg.shrms.service.ProjectsService;
...
/**
 * REST controller for managing {@link com.techvg.shrms.domain.Projects}.
 */
@RestController
@RequestMapping("/api")
public class ProjectsResource {
    ...
    public ResponseEntity<ProjectsDTO> partialUpdateProjects(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, projectsDTO.getId().toString())
        );
    }
