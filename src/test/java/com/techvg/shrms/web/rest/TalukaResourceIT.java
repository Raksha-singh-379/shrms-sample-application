...
import com.techvg.shrms.repository.TalukaRepository;
import com.techvg.shrms.service.criteria.TalukaCriteria;
import com.techvg.shrms.service.dto.TalukaDTO;
import com.techvg.shrms.service.mapper.TalukaMapper;
...
class TalukaResourceIT {
    ...
    void createTaluka() throws Exception {
        ...
        assertThat(testTaluka.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
    ...
    @Test
    @Transactional
    void getAllTalukasByCreatedOnIsEqualToSomething() throws Exception {
        // Initialize the database
        talukaRepository.saveAndFlush(taluka);

        // Get all the talukaList where createdOn equals to DEFAULT_CREATED_ON
        defaultTalukaShouldBeFound("createdOn.equals=" + DEFAULT_CREATED_ON);

        // Get all the talukaList where createdOn equals to UPDATED_CREATED_ON
        defaultTalukaShouldNotBeFound("createdOn.equals=" + UPDATED_CREATED_ON);
    }

    @Test
    @Transactional
    void getAllTalukasByCreatedOnIsInShouldWork() throws Exception {
        // Initialize the database
        talukaRepository.saveAndFlush(taluka);

        // Get all the talukaList where createdOn in DEFAULT_CREATED_ON or UPDATED_CREATED_ON
        defaultTalukaShouldBeFound("createdOn.in=" + DEFAULT_CREATED_ON + "," + UPDATED_CREATED_ON);

        // Get all the talukaList where createdOn equals to UPDATED_CREATED_ON
        defaultTalukaShouldNotBeFound("createdOn.in=" + UPDATED_CREATED_ON);
    }

    @Test
    @Transactional
    void getAllTalukasByCreatedOnIsNullOrNotNull() throws Exception {
        // Initialize the database
        talukaRepository.saveAndFlush(taluka);

        // Get all the talukaList where createdOn is not null
        defaultTalukaShouldBeFound("createdOn.specified=true");

        // Get all the talukaList where createdOn is null
        defaultTalukaShouldNotBeFound("createdOn.specified=false");
    }
    ...
    @Test
    @Transactional
    void getAllTalukasByDeletedContainsSomething() throws Exception {
        // Initialize the database
        talukaRepository.saveAndFlush(taluka);

        // Get all the talukaList where deleted contains DEFAULT_DELETED
        defaultTalukaShouldBeFound("deleted.contains=" + DEFAULT_DELETED);

        // Get all the talukaList where deleted contains UPDATED_DELETED
        defaultTalukaShouldNotBeFound("deleted.contains=" + UPDATED_DELETED);
    }

    @Test
    @Transactional
    void getAllTalukasByDeletedNotContainsSomething() throws Exception {
        // Initialize the database
        talukaRepository.saveAndFlush(taluka);

        // Get all the talukaList where deleted does not contain DEFAULT_DELETED
        defaultTalukaShouldNotBeFound("deleted.doesNotContain=" + DEFAULT_DELETED);

        // Get all the talukaList where deleted does not contain UPDATED_DELETED
        defaultTalukaShouldBeFound("deleted.doesNotContain=" + UPDATED_DELETED);
    }
    ...
    void putExistingTaluka() throws Exception {
        ...
        assertThat(testTaluka.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
