...
public class Holidays implements Serializable {
    ...
    public Holidays holidayName(String holidayName) {
    ...
    public Holidays holidayDate(Instant holidayDate) {
    ...
    public Holidays day(String day) {
        this.setDay(day);
        return this;
    }
    ...
    public Holidays year(Instant year) {
        this.setYear(year);
        return this;
    }
    ...
    public Holidays lastModified(Instant lastModified) {
    ...
    public Holidays lastModifiedBy(String lastModifiedBy) {
    ...
    public Holidays createdBy(String createdBy) {
    ...
    public Holidays createdOn(Instant createdOn) {
    ...
    public Holidays deleted(Boolean deleted) {
    ...
    public Holidays company(Company company) {
