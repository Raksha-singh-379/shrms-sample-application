...
/**
 * Criteria class for the {@link com.techvg.shrms.domain.Taluka} entity. This class is used
 * in {@link com.techvg.shrms.web.rest.TalukaResource} to receive all the possible filtering options from
...
public class TalukaCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, talukaName, lgdCode, createdOn, createdBy, deleted, lastModified, lastModifiedBy, distinct);
    }
