...
class StateResourceIT {
    ...
    void createState() throws Exception {
        ...
        assertThat(testState.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
    ...
    @Test
    @Transactional
    void getAllStatesByCreatedOnIsEqualToSomething() throws Exception {
        // Initialize the database
        stateRepository.saveAndFlush(state);

        // Get all the stateList where createdOn equals to DEFAULT_CREATED_ON
        defaultStateShouldBeFound("createdOn.equals=" + DEFAULT_CREATED_ON);

        // Get all the stateList where createdOn equals to UPDATED_CREATED_ON
        defaultStateShouldNotBeFound("createdOn.equals=" + UPDATED_CREATED_ON);
    }

    @Test
    @Transactional
    void getAllStatesByCreatedOnIsInShouldWork() throws Exception {
        // Initialize the database
        stateRepository.saveAndFlush(state);

        // Get all the stateList where createdOn in DEFAULT_CREATED_ON or UPDATED_CREATED_ON
        defaultStateShouldBeFound("createdOn.in=" + DEFAULT_CREATED_ON + "," + UPDATED_CREATED_ON);

        // Get all the stateList where createdOn equals to UPDATED_CREATED_ON
        defaultStateShouldNotBeFound("createdOn.in=" + UPDATED_CREATED_ON);
    }

    @Test
    @Transactional
    void getAllStatesByCreatedOnIsNullOrNotNull() throws Exception {
        // Initialize the database
        stateRepository.saveAndFlush(state);

        // Get all the stateList where createdOn is not null
        defaultStateShouldBeFound("createdOn.specified=true");

        // Get all the stateList where createdOn is null
        defaultStateShouldNotBeFound("createdOn.specified=false");
    }
    ...
    @Test
    @Transactional
    void getAllStatesByDeletedContainsSomething() throws Exception {
        // Initialize the database
        stateRepository.saveAndFlush(state);

        // Get all the stateList where deleted contains DEFAULT_DELETED
        defaultStateShouldBeFound("deleted.contains=" + DEFAULT_DELETED);

        // Get all the stateList where deleted contains UPDATED_DELETED
        defaultStateShouldNotBeFound("deleted.contains=" + UPDATED_DELETED);
    }

    @Test
    @Transactional
    void getAllStatesByDeletedNotContainsSomething() throws Exception {
        // Initialize the database
        stateRepository.saveAndFlush(state);

        // Get all the stateList where deleted does not contain DEFAULT_DELETED
        defaultStateShouldNotBeFound("deleted.doesNotContain=" + DEFAULT_DELETED);

        // Get all the stateList where deleted does not contain UPDATED_DELETED
        defaultStateShouldBeFound("deleted.doesNotContain=" + UPDATED_DELETED);
    }
    ...
    void putExistingState() throws Exception {
        ...
        assertThat(testState.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
    ...
    void partialUpdateStateWithPatch() throws Exception {
        ...
        partialUpdatedState.stateName(UPDATED_STATE_NAME).lgdCode(UPDATED_LGD_CODE).lastModified(UPDATED_LAST_MODIFIED);
